...
import kotlinx.android.synthetic.main.left_file.view.*
import java.io.File
import java.io.IOException
import java.util.*
import java.util.logging.Logger

class GroupChatAdapter(val context: Context,val guid:String,val ownerId:String):
    ...
    override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
        ...
        when (p0.itemViewType) {
                        ...
                        if (videoThumbnails.get(timeStampLong) == null) {
                            ...
                            try {
                                ...
                                c = context.contentResolver.query(videoUri, requierddata,
                                        MediaStore.MediaColumns.DATA + " like  \"" + filePath + "\"", null, null)
                                if (c != null && c.count != 0) {
            ...
            StringContract.ViewType.RIGHT_AUDIO_MESSAGE -> {
                ...
                rightAudioMessageHolder.binding.audioSeekBar.setProgress(0)
