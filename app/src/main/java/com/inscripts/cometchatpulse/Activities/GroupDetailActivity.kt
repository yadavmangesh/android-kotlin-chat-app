...
class GroupDetailActivity : AppCompatActivity(), OnOptionClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.owner = intent?.getStringExtra(StringContract.IntentString.GROUP_OWNER)
        ...
        groupOptionAdapter = GroupOptionAdapter(this, GroupOptionItemList(), ownerUid, groupId)
        ...
        binding.toolbarTitle.text=getString(R.string.group_detail)
        binding.toolbarTitle.typeface=StringContract.Font.title
        ...
        if (StringContract.AppDetails.theme == Appearance.AppTheme.AZURE_RADIANCE) {
            ...
            binding.toolbarTitle.setTextColor(StringContract.Color.black)

        } else {
            binding.tv30.setBackgroundColor(StringContract.Color.primaryColor)
            binding.toolbarTitle.setTextColor(StringContract.Color.white)
        }
